...
description: This fork is based off of TachiyomiEH, it has most features and fixes from Tachiyomi, TachiyomiJ2K, and TachiyomiSY. It features the old tachiyomi UI with new updates.
lang: en-US
meta:
  - property: og:image
